...
ob_start();
##########
$token = "5818170910:AAGtHJkdeKh4oTL7sAtfxsqfXHXnieLwdVI"; // توكنك
$kindi = "5818170910:AAGtHJkdeKh4oTL7sAtfxsqfXHXnieLwdVI";// توكنك

$buy = "AIikindi";
$userbot ="alamIagbot";
$sudo = "5212007011"; // ايديك
$admin = "$sudo";
$idBot = "5818170910:AAGtHJkdeKh4oTL7sAtfxsqfXHXnieLwdVI";// ايدي بوتك
$admmm = $sudo;
$ADMIN = $sudo;
$Dev = array("$sudo","5212007011");// ايديك
$Devd = "$sudo";
$tbbots = alamIagbot;/// يوزر بوتك بدون @
